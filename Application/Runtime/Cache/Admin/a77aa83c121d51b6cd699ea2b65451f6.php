...
<div class="col-sm-9 col-md-9 col-lg-10">
    <section class="mainbody">
        <ol class="breadcrumb">
            ...
            <li class="active"><i class='fa fa-edit'></i> 菜单编辑</li>          
        </ol> 
        ...
        <form id="editForm" class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" maxlength="50"  placeholder="请输入菜单名" name ="name" value="<?php echo ($menu["name"]); ?>">
                </div>
            </div>
            
            <?php if($menu["module"] == 'Admin'): ?><!-- 后台菜单才显示图标供选择 前端菜单没图标 -->
            <div class="form-group">
                <label class="col-sm-3 control-label">菜单图标类：</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" maxlength="30" placeholder="请输入菜单图标类" name="fa_icon" value="<?php echo ($menu["fa_icon"]); ?>">
                </div>
            </div><?php endif; ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <label class=" radio-inline">
                        <input type="radio" value="Home" name="module"  <?php if($menu["module"] == 'Home'): ?>checked<?php endif; ?>>前端导航
                    </label>           
                    <label class=" radio-inline">
                        <input type="radio" value="Admin" name="module" <?php if($menu["module"] == 'Admin'): ?>checked<?php endif; ?>>后台菜单
                    </label>   
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" maxlength="20" placeholder="请输入控制器名" name="controller" value="<?php echo ($menu["controller"]); ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" maxlength="20" placeholder="请输入方法名" name="function" value="<?php echo ($menu["function"]); ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <label class='radio-inline'>
                        <input type="radio" name="status" value="1" <?php if($menu["status"] == 1): ?>checked<?php endif; ?>>正常
                    </label>
                    <label class="radio-inline">
