...
<div class="col-sm-9 col-md-9 col-lg-10">
    <section class="mainbody">
        <ol class="breadcrumb">
            ...
            <li class="active"><i class='fa fa-edit'></i> 编辑下载文件 </li>
        </ol>
         <form id="editForm" class="form-horizontal">
            <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">文件名：</label>
                <div class="col-sm-9 col-lg-6">
                    <input type="text" class="form-control" maxlength="255" autocomplete="off"  placeholder="请输入文件名" name ="name" id="name" value="<?php echo ($file["name"]); ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                 ...
                 <div class="col-sm-9 col-lg-6">
                     <select class="form-control" name="products_type" id="productsType">
                         ...
                         <?php if(is_array($productsType)): $i = 0; $__LIST__ = $productsType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo["id"] == $file['products_type']): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                     </select>  
                 </div>
            </div>
            ...
            <div class="form-group">
                 ...
                 <div class="col-sm-9 col-lg-6">
                     ...
                     <output hidden id="output"><?php echo ($file["products_id"]); ?></output>
                 </div>
            </div>
             ...
             <div class="form-group">
                 ...
                 <div class="col-sm-9 col-lg-6">
                    ...
                    <input id="path" type="hidden" multiple="true"  name="path" value="<?php echo ($file["path"]); ?>">
                 </div>
             </div> 
            <div class="form-group">
                ...
                <div class="col-sm-9 col-lg-6">
                    <label class='radio-inline'>
                        <input type="radio" name="status" value="1" <?php if($file["status"] == 1): ?>checked<?php endif; ?> >正常
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="status" value="0" <?php if($file["status"] == 0): ?>checked<?php endif; ?> >关闭
                    </label>
                </div>
            </div>
...
<script>
    var SCOPE = {
        ...
        ajax_upload_file_url : "/Admin/Image/ajaxuploadfile",//后台接口处理ajax上传的图片
