...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Search | ltechlighting led tube linear troffer lights</title>
        <meta name="viewport" content="width=device-width, initial-scale=1,maximum-scale=1,minimum-scale=1,user-scalable=no">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">      
        <meta name="description" content="ltech ltechlighting led lights">
        ...
        <style>
            ...
            .search-bg{
                max-width: 100%;
                min-height: 180px;
                background: url("/Public/img/home/search-bg.jpg") center center no-repeat;
            }
            @media screen and (min-width:768px){
                .search-bg{min-height: 310px}
            }
            .search-input{
                border-radius: 0;
            }
            ...
            button.btn-search:hover,button.btn-search:active,button.btn-search:visited,button.btn-search:focus{
            ...
            .result-row a:hover,.result-row a:active{
                color: #e41930;
            }
...
<nav class="navbar navbar-default navbar-fixed-top m-b-0" style="box-shadow: 0 2px 7px rgba(100,100,100,.5);">
    ...
    <div class="container-fluid">
        <div class="row ">
            <div class="center-bloack search-bg"></div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-xs-12" style="margin-top: 10px;">
                ...
                <div class="input-group">
                    <input type="text"  class="form-control input-lg search-input " id="searchValue" maxlength="88" placeholder="Search Products..."  value='<?php echo ($keyword); ?>'>
                    <span class="input-group-btn">
                        <button type="button" id="search"  class="btn input-lg  btn-search box-shadow">SEARCH</button>
                    </span>
                </div>
        ...
        <div class="row row-block">
            <div class="col-xs-12">
                <p class='p-result'>Search results for:'<span id="showKeyword"><?php echo ($keyword); ?></span>'</p>
            </div>
        </div>
        
        <div id="resultPane">
            <?php if($res == 'no'): ?><p class='p-noresult'>Sorry, did not find the relevant results, try another keyword please.</p><?php endif; ?>
<?php if(is_array($result)): foreach($result as $key=>$list): ?><div class="row " >
        <div class="col-xs-12 ">
            
            <div class='result-row  clearfix'>
                <div class="col-sm-6 col-md-5 -col-lg-4">
                    <a href="<?php echo U('Products/product',array('id' => $list[products_id]));?>" target='_blank'><img class="img-responsive center-bloack" src="<?php echo ($list["thumb"]); ?>" alt="<?php echo ($list["name"]); ?>"></a>
                </div>
                <div class="col-sm-6 col-md-7 -col-lg-8">
                    <h3><a href="<?php echo U('Products/product',array('id' => $list[products_id]));?>" target='_blank'><?php echo ($list["name"]); ?></a></h3>
...
<div id="SkypeButton_Call_ltechlighting_1" title="chat me!"> </div>
    ...
    <script>
        var SCOPE={
            search_url:"<?php echo U('Search/index');?>"
        };
    </script>
