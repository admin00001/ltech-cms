...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Projects | ltechlighing projects</title>
        <meta name="viewport" content="width=device-width, initial-scale=1,maximum-scale=1,minimum-scale=1,user-scalable=no">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">      
        <meta name="description" content="there are our company projects after ltechlighting was set up.">
        <meta name="keywords" content="projects  led lighting linear lights tube t8">      
        ...
        <div class="row row-block">
            <div class="col-xs-12">
                <div class="news-breadcrumb">
                    ...
                    <a class="active" title="Projects">Projects</a>
                </div>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-sm-4 col-lg-3 ">
                <?php
$listdata = array('status' => 1); $limit = 10; $list = D("Projects")->select($listdata,$limit); ?>
<div class="border">
    ...
    <?php if(is_array($list)): foreach($list as $key=>$list): ?><div class="list">
            ...
            <div class="col-sm-8 col-lg-9">
                <?php if($res == 'no'): ?><p class='text-center' style="color: #e62129">Sorry,do not exists this project.</p><?php endif; ?>
                <?php if(is_array($Projectslist)): foreach($Projectslist as $key=>$list): ?><div class="row " style="margin-bottom: 30px;">
                        <div class="col-xs-5 col-sm-4 col-lg-3">
                            <a href="<?php echo U('Projects/detail',array('id' => $list[projects_id]));?>"><img class="img-responsive center-block" src="<?php echo ($list["thumb"]); ?>" alt="<?php echo ($list["name"]); ?>"></a>
                        </div>
                        <div class="col-xs-7 col-sm-8 col-lg-9">
                            <a href="<?php echo U('Projects/detail',array('id' => $list[projects_id]));?>"><p class="projects-name"><?php echo ($list["name"]); ?></p></a>
...
<div id="SkypeButton_Call_ltechlighting_1" title="chat me!"> </div>
    ...
    <script>
        var SCOPE = {search_url:"<?php echo U('Projects/index');?>"};
    </script>
