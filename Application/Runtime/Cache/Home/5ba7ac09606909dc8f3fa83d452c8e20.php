...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="project led lighting linear lights tube t8">      

        <link rel="icon" href="/favicon.ico">

        <link href="/Public/bootstrap/css/bootstrap.min.css" rel="stylesheet">
        <link href="/Public/css/font-awesome.css" rel="stylesheet" >
        <link href="/Public/jssocials-1.4.0/dist/jssocials.css" rel="stylesheet" />
        <link href="/Public/jssocials-1.4.0/dist/jssocials-theme-flat.css" rel="stylesheet" />
        ...
        <div class="row row-block">
            <div class="col-xs-12">
                <div class="news-breadcrumb">
                    ...
                    <a href="<?php echo U('Projects/index');?>" title="Projects">Projects</a><span>/</span>
...
<div class="border">
    ...
    <?php if(is_array($list)): foreach($list as $key=>$list): ?><div class="list">
            ...
            <div class="col-sm-8 col-lg-9">
                <h1 class="projects-name text-center"><?php echo ($project["name"]); ?></h1>
                <p class='text-center'>Start-time:<?php echo ($project["start_time"]); ?> | End-time:<?php echo ($project["end_time"]); ?> |<span class="fa fa-eye ">(<?php echo ($project["count"]); ?>)</span></p>
...
<div id="SkypeButton_Call_ltechlighting_1" title="chat me!"> </div>
    ...
    <!--分享功能js插件-->
    <script src="/Public/jssocials-1.4.0/dist/jssocials.min.js"></script>
    <script>
        $("#share").jsSocials({
            showLabel: false,
            showCount: false,
    ...
    <script>
        var SCOPE = {
            search_url:"<?php echo U('Projects/index');?>"
        };
    </script>
