        ...
        <div class="row row-block">
            <div class="col-xs-12">
                <div class="news-breadcrumb">
                    ...
                    <a href="<?php echo U('News/index');?>" title="News">News</a><span>/</span>
...
<div class="border">
    ...
    <?php if(is_array($list)): foreach($list as $key=>$list): ?><div class="list">
            ...
            <div class="col-sm-8 col-lg-9">
                <h1 class="news-title text-center"><?php echo ($news["title"]); ?></h1>
                <p class='text-center'><?php echo (date("Y-m-d",$news["create_time"])); ?> | <span class="fa fa-eye ">(<?php echo ($news["count"]); ?>)</span></p>
