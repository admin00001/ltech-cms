...
<div class="col-sm-9 col-md-9 col-lg-10">
    <section class="mainbody">
        <ol class="breadcrumb">
            ...
            <li class="active"><i class='fa  fa-picture-o'></i> 推荐位管理 </li>          
        </ol> 
        <button class="btn btn-default  add" id="btnAdd"><i class="fa fa-plus"></i>添加推荐位</button>
        ...
        <div class="table-responsive">
            <table class="table table-hover table-bordered table-striped">
                ...
                <tbody>
                <?php if(is_array($position)): foreach($position as $key=>$position): ?><tr>
                        ...
                        <td>
                            <a id="edit"   class="edit" title="编辑"  data-behavior="编辑" data-id="<?php echo ($position["position_id"]); ?>" ><i class="fa fa-edit"></i> 编辑</a>
                            <a id="delete" class="delete" title="删除" data-behavior="删除" data-id="<?php echo ($position["position_id"]); ?>" data-status = "-1"><i class="fa fa-trash"></i> 删除</a>
                        </td>
...
<script>
    var SCOPE ={
        add_url: "<?php echo U('Position/add');?>",
        edit_url: "<?php echo U('Position/edit');?>",
        set_status_url: "<?php echo U('Position/setStatus');?>",
        listorder_url: "<?php echo U('Position/listorder');?>"  
    };
</script>
