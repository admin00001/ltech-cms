...
<div class="col-sm-9 col-md-9 col-lg-10">
    <section class="mainbody">
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-plus"></i>添加产品</li>          
        </ol> 
        ...
        <form id="editForm" class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-sm-6 ">
                    <input type="text" class="form-control" maxlength="50"  placeholder="请输入产品名 限50字符" name ="name" value="">
                </div>
            </div>
            ...
            <div class="form-group" >
                ...
                <div class="col-sm-6 ">
                    <?php if(is_array($type)): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><label class=" radio-inline">
                            <input type="radio" value="<?php echo ($vo["id"]); ?>" name="type" > <?php echo ($vo["name"]); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-lg-6">
                    <input type="text" class="form-control" maxlength="70" placeholder="产品title 最好55字符内 限70字符" name="title" value="">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-lg-10">
                    <input type="text" class="form-control" maxlength="200" placeholder="请输入keywords 限200字符" name="keywords" value="">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-lg-10">
                    <input type="text" class="form-control" maxlength="200" placeholder="请输入description 限200字符" name="description" value="">
                </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-9 col-lg-6">
                    ...
                    <img style="display: none" id="img_main_img" src="" class="img-responsive" alt="" >
                    <input id="img_main" name="img_main" type="hidden" multiple="true" value="">
                </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-9 col-lg-6">
                    <textarea class="form-control description" name="description_one"  placeholder="产品描述一"></textarea>
                </div>
            </div>
            <hr>
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-9 col-lg-6">
                    <textarea class="form-control description" name="description_two"  placeholder="产品描述二"></textarea>
                </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-9 col-lg-6">
                    ...
                    <img style="display: none" id="img_application_one_img" src="" class="img-responsive" alt="" >
                    <input id="img_application_one" name="img_application_one" type="hidden" multiple="true" value="">
                </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-9 col-lg-6">
                    ...
                    <img style="display: none" id="img_application_two_img" src="" class="img-responsive" alt="" >
                    <input id="img_application_two" name="img_application_two" type="hidden" multiple="true" value="">
                </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-9 col-lg-6">
                    <textarea class="form-control description" name="description_three"  placeholder="产品描述三"></textarea>
                </div>
            </div>
            <hr>
            <div class="form-group ">
                ...
                <div class="col-sm-9 col-lg-6">
                    ...
                    <img style="display: none" id="family_products_img" src="" class="img-responsive" alt="" >
                    <input id="family_products" name="family_products" type="hidden" multiple="true" value="">
                </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-9 col-lg-6">
                    ...
                    <img style="display: none" id="img_small_one_img" src="" class="img-responsive" alt="" >
                    <input id="img_small_one" name="img_small_one" type="hidden" multiple="true" value="">
                </div>            
            </div>
            <hr>
            <div class="form-group ">
                ...
                <div class="col-sm-9 col-lg-6">
                    ...
                    <img style="display: none" id="img_small_two_img" src="" class="img-responsive" alt="" >
                    <input id="img_small_two" name="img_small_two" type="hidden" multiple="true" value="">
                </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-9 col-lg-6">
                    ...
                    <img style="display: none" id="img_small_three_img" src="" class="img-responsive" alt="" >
                    <input id="img_small_three" name="img_small_three" type="hidden" multiple="true" value="">
                </div>              
            </div>
            <hr>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-lg-10">
                    <textarea class="kindeditor form-control" id="featureEditor" name="features" ></textarea>
                 </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9 col-lg-10">
                  <textarea class="kindeditor form-control" id="specification_features" name="specification_features" ></textarea>
              </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-9 col-lg-6">
                    ...
                    <img style="display: none" id="data_banner_one_img" src="" class="img-responsive" alt="" >
                    <input id="data_banner_one" name="data_banner_one" type="hidden" multiple="true" value="">
                </div>             
            </div>
            <hr>
            <div class="form-group ">
                ...
                <div class="col-sm-9 col-lg-6">
                    ...
                    <img style="display: none" id="data_banner_two_img" src="" class="img-responsive" alt="" >
                    <input id="data_banner_two" name="data_banner_two" type="hidden" multiple="true" value="">
                </div>             
            </div>
            <hr>
            <div class="form-group ">
                ...
                <div class="col-sm-9 col-lg-6">
                    ...
                    <img style="display: none" id="data_banner_three_img" src="" class="img-responsive" alt="" >
                    <input id="data_banner_three" name="data_banner_three" type="hidden" multiple="true" value="">
                </div>             
            </div>
            <hr>
            <div class="form-group ">
                ...
                <div class="col-sm-9 col-lg-6">
                    ...
                    <img style="display: none" id="data_banner_four_img" src="" class="img-responsive" alt="" >
                    <input id="data_banner_four" name="data_banner_four" type="hidden" multiple="true" value="">
                </div>             
            </div>
            <hr>
            <div class="form-group ">
                ...
                <div class="col-sm-9 col-lg-6">
                    ...
                    <img style="display: none" id="data_banner_five_img" src="" class="img-responsive" alt="" >
                    <input id="data_banner_five" name="data_banner_five" type="hidden" multiple="true" value="">
                </div>             
            </div>
            <hr>
            <div class="form-group">
              ...
              <div class="col-sm-9 col-lg-10">
                  <textarea class="kindeditor form-control" id="extra_one" name="extra_one" ></textarea>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9 col-lg-10">
                  <textarea class="kindeditor form-control" id="extra_two" name="extra_two" ></textarea>
              </div>
            </div>
...
<script>
    var options ={
     ...
     KindEditor.ready(function(K) {
                ...
                window.editor = K.create('#specification_features',options);//Specification Features 编辑器
                window.editor = K.create('#extra_one',options); //额外添加一编辑器
                window.editor = K.create('#extra_two',options); //额外添加二编辑器
                });
</script>
