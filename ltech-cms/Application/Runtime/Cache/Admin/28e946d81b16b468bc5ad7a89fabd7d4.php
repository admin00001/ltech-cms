...
<div class="col-sm-9 col-md-9 col-lg-10">
    <section class="mainbody">
        <ol class="breadcrumb">
            ...
            <li class="active"><i class='fa fa-refresh fa-spin'></i> 修改产品类型 </li>          
        </ol> 
        <form class ="form-horizontal" id="editForm">
            <div class="form-group" >
                <label class="col-sm-3 col-lg-2 control-label">产品类型名：</label>
                <div class="col-sm-9 col-lg-6">
                    <input type="text" class="form-control" maxlength="255" placeholder="产品类型名" name="name" value="<?php echo ($type["name"]); ?>">
                </div>
            </div>
            <div class="form-group" >
                <label class="col-sm-3 col-lg-2 control-label">产品介绍：</label>
                <div class="col-sm-9 col-lg-6">
                    <textarea class="form-control description" maxlength="2000" placeholder="产品介绍" name="introduce" ><?php echo ($type["introduce"]); ?></textarea>
                </div>
            </div>
            <div class="form-group ">
                ...
                <div class="col-sm-9 col-lg-6">
                    ...
                    <img style="display: none" id="thumb_img" src="<?php echo ($type["thumb"]); ?>" class="img-responsive" alt="" >
                    <input id="thumb" name="thumb" type="hidden" multiple="true" value="<?php echo ($type["thumb"]); ?>">
                </div>
            </div>
            <hr> 
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <label class='radio-inline'>
                        <input type="radio" name="status" value="1" <?php if($type["status"] == 1): ?>checked<?php endif; ?> >正常
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="status" value="0" <?php if($type["status"] == 0): ?>checked<?php endif; ?> >关闭
                    </label>
                </div>
            </div>
