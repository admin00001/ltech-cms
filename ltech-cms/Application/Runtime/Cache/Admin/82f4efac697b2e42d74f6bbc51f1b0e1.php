...
<div class="col-sm-9 col-md-9 col-lg-10">
    <section class="mainbody">
        <ol class="breadcrumb">
            ...
            <li class="active"><i class='fa fa-plus '></i> 添加用户 </li>          
        </ol> 
        <form id="editForm" class="form-horizontal">
            <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">用户名：</label>
                <div class="col-sm-9 col-lg-6">
                    <input type="text" class="form-control" maxlength="255" autocomplete="off"   placeholder="请输入用户名,登录专用" name ="username" value="">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">真实姓名：</label>
                <div class="col-sm-9 col-lg-6">
                    <input type="text" class="form-control" maxlength="255"  autocomplete="off"  placeholder="请输入真实姓名" name ="realname" value="">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">密码：</label>
                <div class="col-sm-9 col-lg-6">
                    <input type="password" class="form-control" maxlength="255"  autocomplete="off"  placeholder="请输入密码" name ="password" value="">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">确认密码：</label>
                <div class="col-sm-9 col-lg-6">
                    <input type="password" class="form-control" maxlength="255"  autocomplete="off"   placeholder="请输入确认密码" name="comfirmPsw" value="">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">email：</label>
                <div class="col-sm-9 col-lg-6">
                    <input type="email" class="form-control" maxlength="255" autocomplete="off" placeholder="请输入email" name ="email" value="">
                </div>
            </div>
