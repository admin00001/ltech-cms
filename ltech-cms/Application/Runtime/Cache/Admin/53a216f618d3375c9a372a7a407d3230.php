        ...
        <form id="editForm" class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-sm-9 col-lg-6">
                    <input type="text" class="form-control" readonly autocomplete="off"   placeholder="请输入用户名" name ="username" value="<?php echo ($personal["username"]); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">真实姓名：</label>
                <div class="col-sm-9 col-lg-6">
                    <input type="text" class="form-control" maxlength="255"  autocomplete="off"  placeholder="请输入真实姓名" name ="realname" value="<?php echo ($personal["realname"]); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">密码：</label>
                <div class="col-sm-9 col-lg-6">
                    <input type="password" class="form-control" maxlength="255"  autocomplete="off"  placeholder="输入密码" name ="password" value="">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">确认密码：</label>
                <div class="col-sm-9 col-lg-6">
                    <input type="password" class="form-control" maxlength="255"  autocomplete="off"   placeholder="请确认密码" name="comfirmPsw" value="">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">email：</label>
                <div class="col-sm-9 col-lg-6">
                    <input type="email" class="form-control" maxlength="255" autocomplete="off" placeholder="请输入email" name ="email" value="<?php echo ($personal["email"]); ?>">
                </div>
            </div>
            <input type="hidden" name="admin_id" value="<?php echo ($personal["admin_id"]); ?>">
