...
<div class="col-sm-9 col-md-9 col-lg-10">
    <section class="mainbody">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo U('Projects/index');?>"><i class='fa fa-bar-chart'></i> Projects 管理 </a> </li>
            <li class="active"><i class='fa fa-deit'></i> 编辑 Projects</li>          
        </ol> 
        
        <form id="editForm" class="form-horizontal">
            <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">项目名：</label>
                <div class="col-sm-9 col-lg-6">
                    <input type="text" class="form-control" maxlength="255"  placeholder="请输入项目名" name ="name" value="<?php echo ($projects["name"]); ?>">
                </div>
            </div>
            
            <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">项目开始时间：</label>
                <div class="col-sm-9 col-lg-6">
                    <input type="date" class="form-control" maxlength="255"  placeholder="请输入项目开始时间" name ="start_time" value="<?php echo ($projects["start_time"]); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">项目结束时间：</label>
                <div class="col-sm-9 col-lg-6">
                    <input type="date" class="form-control" maxlength="255"  placeholder="请输入项目结束时间" name ="end_time" value="<?php echo ($projects["end_time"]); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">description：</label>
                <div class="col-sm-9 col-lg-6">
                    <input type="text" class="form-control" maxlength="255" placeholder="项目描述" name="description" value="<?php echo ($projects["description"]); ?>">
                </div>
            </div>
            ...
            <div class="form-group" >
               ...
               <div class="col-sm-9 col-lg-6">
                    ...
                    <img style="display: none" id="thumb_img" src="<?php echo ($projects["thumb"]); ?>" class="img-responsive" alt="" >
                    <input id="thumb" name="thumb" type="hidden" multiple="true" value="<?php echo ($projects["thumb"]); ?>">
                </div>
            </div>
            
            <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">内容：</label>
                <div class="col-sm-9 col-lg-6">
                    <textarea class="form-control description" id="contentEditor" name="content"  placeholder="content"><?php echo ($projects["content"]); ?></textarea>
                </div>
            </div>
            
            <div class="form-group">
                <label class="col-sm-3  col-lg-2 control-label">Projects状态：</label>
                <div class="col-sm-9 col-lg-6">
                    <label class='radio-inline'>
                        <input type="radio" name="status" value="1" <?php if($projects["status"] == 1): ?>checked<?php endif; ?>>正常
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="status" value="0" <?php if($projects["status"] == 0): ?>checked<?php endif; ?>>关闭
                    </label>
                </div>
            </div>
...
<script>
    var SCOPE = {
        save_url : "<?php echo U('Projects/add');?>"  ,
        jump_url : "<?php echo U('Projects/index');?>",
    ...
    var options ={
        ...
        afterBlur : function(){this.sync();} ,//文本框失焦 就同步文本框的内容到textarea 的 value值里面
