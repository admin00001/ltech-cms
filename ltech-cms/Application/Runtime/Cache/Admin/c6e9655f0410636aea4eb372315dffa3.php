...
<script>
    var SCOPE = {
        add_banner_url: "<?php echo U('Homeindex/addBanner');?>",
        edit_banner_url: "<?php echo U('Homeindex/editBanner');?>",
        edit_adv_url: "<?php echo U('Homeindex/editAdv');?>",
        set_status_url: "<?php echo U('Homeindex/setStatus');?>",
        listorder_url: "<?php echo U('Homeindex/listorder');?>",
        ...
        save_catalogue_url:"<?php echo U('Homeindex/saveCatalogue');?>"
    };

</script>
<script src="/Public/js/Admin/Homeindex.js"></script>
</body>
</html>