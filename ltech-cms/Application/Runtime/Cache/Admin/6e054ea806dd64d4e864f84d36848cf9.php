...
<div class="col-sm-9 col-md-9 col-lg-10">
    <section class="mainbody">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo U('Position/index');?>"><i class='fa fa-picture-o'></i> 推荐位管理</a></li>
            <li class="active"><i class='fa  fa-edit'></i> 编辑推荐位 </li>          
        </ol> 
        <form class ="form-horizontal" id="editForm">
            <div class="form-group" >
                <label class="col-sm-3 col-lg-2 control-label">推荐位名：</label>
                <div class="col-sm-9 col-lg-6">
                    <input type="text" class="form-control" maxlength="255" placeholder="推荐位名" name="name" value="<?php echo ($position["name"]); ?>">
                </div>
            </div>
            <div class="form-group" >
                <label class="col-sm-3 col-lg-2 control-label">推荐位描述：</label>
                <div class="col-sm-9 col-lg-6">
                    <input type="text" class="form-control" maxlength="255" placeholder="推荐位描述" name="description" value="<?php echo ($position["description"]); ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <label class='radio-inline'>
                        <input type="radio" name="status" value="1" <?php if($position["status"] == 1): ?>checked<?php endif; ?>>正常
                    </label>
                    <label class="radio-inline">
...
<script>
    var SCOPE = {
        save_url: "<?php echo U('Admin/Position/add');?>",
        jump_url: "<?php echo U('Admin/Position/index');?>"
    };
</script>
