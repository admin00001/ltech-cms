...
<div class="col-sm-9 col-md-9 col-lg-10">
    <section class="mainbody">
        <ol class="breadcrumb">
            ...
            <li class="active"><i class='fa fa-plus'></i> 添加News</li>          
        </ol> 
        ...
        <form id="editForm" class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-sm-9 col-lg-6">
                    <input type="text" class="form-control" maxlength="255"  placeholder="请输入title" name ="title" value="">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-lg-6">
                    <input type="text" class="form-control" maxlength="255" placeholder="描述description" name="description" value="">
                </div>
            </div>

            <div class="form-group" >
                <label class="col-sm-3 col-lg-2 control-label">缩略图(380x380):</label>
               <div class="col-sm-9 col-lg-6">
